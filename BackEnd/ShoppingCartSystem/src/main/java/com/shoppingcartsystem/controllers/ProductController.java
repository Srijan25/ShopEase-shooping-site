...
public class ProductController {
	...
	public ResponseEntity<ProductDto> createProduct(@RequestBody ProductDto productDto, @PathVariable Integer categoryId, @PathVariable Integer merchantId){
...
//	}
	...
	public ResponseEntity<ProductResponse> getProductsByCategory(@PathVariable Integer categoryId,
		...
		ProductResponse productResponse = this.productService.getProductByCategory(categoryId, pageNumber, pageSize, sortBy, sortDir);
	...
	public ResponseEntity<ProductDto> uploadMultipleProductImages(@RequestParam("images") MultipartFile[] images, @PathVariable Integer productId) throws IOException{
		ProductDto productDto = this.productService.getProductById(productId);
	...
	public ResponseEntity<ProductResponse> getProductsByMerchantId(@PathVariable Integer merchantId,
		...
		ProductResponse productDtos= this.productService.getByMerchantId(merchantId, pageNumber, pageSize, sortBy, sortDir);
