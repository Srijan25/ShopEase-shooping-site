...
//
//		Category category = this.categoryRepository.findById(productDto.getCategory().getCategoryId())
//				.orElseThrow(() -> new ResourceNotFoundException("Category", "Id", productDto.getCategory().getCategoryId()));
//
//		Product product = this.modelMapper.map(productDto, Product.class);
//		product.setCategory(category);
//
...
//	}
	...
	public ProductDto updateProduct(ProductDto productDto, Integer productId) {
		...
		// product.setCategory(this.modelMapper.map(productDto.getCategory(),
		// Category.class));
	...
	public void deleteProduct(Integer productId) {
		...
		//this.fileService.deleteImage(product.getProductPhoto());
