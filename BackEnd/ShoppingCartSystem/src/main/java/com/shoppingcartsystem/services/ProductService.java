...
//	ProductDto createProduct(ProductDto productDto);
	...
	ProductResponse getProductByCategory(Integer categoryId, Integer pageNumber, Integer pageSize, String sortBy, String sortDir);
	
	ProductResponse searchProducts(String keyword, Integer pageNumber, Integer pageSize, String sortBy, String sortDir);
	
	ProductResponse getByMerchantId(Integer merchantId, Integer pageNumber, Integer pageSize, String sortBy, String sortDir);
}
